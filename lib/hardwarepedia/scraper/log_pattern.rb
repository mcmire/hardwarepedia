...
# This is copied completely from Logging::Layouts::Pattern
# because of the constants and metaprogramming stuff
...
module Hardwarepedia
  class Scraper
    ...
    #
    class LogPattern < ::Logging::Layout
      ...
      DIRECTIVE_TABLE = {
        ...
        '%' => :placeholder,
        # ADDED
        'S' => 'Thread.current.object_id.to_s(36)',
        's' => 'Thread.current[:sidekiq_context] ? " " + Thread.current[:sidekiq_context] + " " : ""'
      }.freeze
